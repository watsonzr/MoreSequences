...
def run_test_generate_points_on_circle():
    ...
    # Test 2:
    expected = [rg.Point(300, 200),  # All numbers are approximate.
                rg.Point(200, 300),
                rg.Point(100, 200),
                rg.Point(200, 100)]
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 5:  300 segments, hops = 61.'
    window = rg.RoseWindow(400, 400, title)
    ...
    title = 'FANCY POLYGON test 6:  51 segments, hops = 25.'
    window = rg.RoseWindow(400, 400, title)
...
def fancy_polygon(window, circle, number_of_lines, hops_to_next_point, color, thickness):
    ...
    for i in range(number_of_lines):
        if i + hops_to_next_point >= number_of_lines:
            second_point = i + hops_to_next_point - number_of_lines
        else:
            second_point = i + hops_to_next_point
        line = rg.Line(points[i], points[second_point])
        line.color = color
        line.thickness = thickness
        line.arrow = 'last'
        line.attach_to(window)
